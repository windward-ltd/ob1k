...
public class ComposableFutureTest {
  ...
  public void testBatchUnorderedDoesNotCauseStackOverflowErrorSync() throws Exception {
    ComposableFutures.batchUnordered(Collections.nCopies(100_000, 1), 1, result -> ComposableFutures.fromNull()).get();
  }

  @Test
  public void testBatchUnorderedDoesNotCauseStackOverflowErrorAsync() throws Exception {
    ComposableFutures.batchUnordered(Collections.nCopies(100_000, 1), 2, result -> ComposableFutures.submit(() -> 0)).get();
  }
